          ...
          <div className="relative grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="mt-4 text-3xl md:text-5xl font-semibold text-on-deep text-balance">
                Tem um <span className="text-gradient-accent">caso técnico</span>, uma falha ou uma
                dúvida normativa?
              </h2>
              <p className="mt-5 text-lg text-muted-on-deep leading-relaxed">
                Conte com a Arlura para uma análise inicial. Respondemos com objetividade e
                indicamos o caminho técnico mais adequado para o seu contexto.
              </p>
            ...
            <ul className="grid gap-4">
              {[
                ...
                >
                  <span className="text-xs uppercase tracking-wider text-muted-on-deep">{i.k}</span>
                  <span className="text-sm font-medium text-on-deep text-right">{i.v}</span>
                </li>
              ))}
            </ul>
          </div>
